...
namespace TranslateTool
{
    public partial class Form1 : Form
    {
        ...
        private void Form1_Load(object sender, EventArgs e)
        {
            ...
            toolTip1.SetToolTip(button8, "Click here to select the previous text to be translated.");
            toolTip1.SetToolTip(button9, "Click here to select the next text to be translated.");
            toolTip1.SetToolTip(button11, "Click here to show Google Translate.");
            toolTip1.SetToolTip(button12, "Click here to clear highlighted texts.");
            ...
            toolTip1.SetToolTip(numericUpDown1, "Enter the number of times the macro should repeat tasks.");
            toolTip1.SetToolTip(numericUpDown2, "Change the interval in seconds (min. 2 / max. 10) if the macro is skipping some translations.");
            toolTip1.SetToolTip(checkBox1, "Keep this application window always on top.");
